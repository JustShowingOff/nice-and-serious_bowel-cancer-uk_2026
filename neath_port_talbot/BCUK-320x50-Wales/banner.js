...
var  bubble1, logos, cover1, cover2, cover3, copy1,copy1a, copy2, copy2a, cta
...
var createAnimation = function () {
    ...
    gsap.set([bubble1, bubble2], { scale: .5, x: 7, y: -37, transformOrigin: "0% 100%" })
    ...
    timeline.addLabel("frame1")
        ...
        .from(bubble1, { duration: .35, scale: 0, transformOrigin: "0% 100%", ease: "back.out(0.9)" }, "frame1")


        .to(bubble1, { duration: .1, alpha: 0, transformOrigin: "0% 100%", ease: "none" }, "frame1+=2")


        .from(bubble2, { duration: .35, scale: 0, transformOrigin: "0% 100%", ease: "back.out(0.9)" })


        .addLabel("frame2", "+=2")

        .to(bubble1, { duration: 1, x:"-=320", alpha: 0, ease: "power1.inOut" }, "frame2")

        .from(cover1, { duration: 1, x: "+=320", ease: "power1.inOut" }, "frame2")
        ...
        .from(copy1aSplit.words, { duration: .5, y: "+=50", alpha: 0, ease: "power1.out", stagger: { amount: 0.35 } })



        .addLabel("frame3", "+=1.5")

        .from(cover2, { duration: 1, x: "+=320", ease: "power1.inOut" }, "frame3")

        .from(copy2Split.lines, { duration: .5, y: "+=50", alpha: 0, ease: "power1.out", stagger: { amount: 0.35 } }, "frame3+=1")
        ...
        .from(cover3, { duration: 1, x: "+=320", ease: "power1.inOut" }, "frame4")
