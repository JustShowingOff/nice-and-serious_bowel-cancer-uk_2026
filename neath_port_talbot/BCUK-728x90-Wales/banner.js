...
var image1, image2, image1Container, image2Container, bubble1, bubble2, bubble3, logo, logos, cover1, cover2, cover3, copy1, copy1a, copy2, copy2a , cta
...
var createAnimation = function () {
   ...
   var copy1Split = new SplitText(copy1, { type: "words" })
    ...
    gsap.set([bubble1, bubble3], { scale: .5, x: 145, y: 11, transformOrigin: "0% 0%" })
    gsap.set(bubble2, { scale: .5, x: 371, y: -39, transformOrigin: "50% 100%" })
    ...
    timeline.addLabel("frame1")
        ...
        //  .from(image2Container, { duration: 1, alpha: 0, x: "+=50", ease: "power.out" }, "frame3+=0.5")
