...
var createAnimation = function () {
    ...
    gsap.set(bubble1, { scale: .5, x: -87, y: -126, transformOrigin: "50% 100%" })
    gsap.set(bubble2, { scale: .5, x: 166, y: -101, transformOrigin: "100% 100%" })

    gsap.set(copy2, { y: -100 })
    ...
    timeline.addLabel("frame1")
        ...
        .from(image2, { duration: 1, alpha:0, y:"+=20", ease: "power1.inOut" }, "frame3+=0.5")
