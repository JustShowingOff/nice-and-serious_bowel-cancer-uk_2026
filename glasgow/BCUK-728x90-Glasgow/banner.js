...
var createAnimation = function () {
    ...
    gsap.set(bubble1, { scale: .5, x: -173, y: 0, transformOrigin: "100% 20%" })
   ...
   // gsap.set(copy2, { y: -70 })
    ...
    timeline.addLabel("frame1")
        ...
        .from(bubble1, { duration: .35, scale: 0, transformOrigin: "100% 20%", ease: "back.out(1.7)" }, "frame1")

        .to(image1Container, { duration: 4.5, x:"+=30", ease: "none" }, "frame1")
        ...
        .to(image1Container, { duration: 1.5, x:"+=150", alpha: 0, ease: "power1.inOut" }, "frame2")
        ...
        .to([copy2, image2Container], { duration: 1, x: "-=100", alpha: 0, ease: "power1.inOut" }, "frame4")
