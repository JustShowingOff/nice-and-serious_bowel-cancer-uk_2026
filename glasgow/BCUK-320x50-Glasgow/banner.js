...
var init = function () {
    ...
    timeline = gsap.timeline({
        id: "timeline", repeat: 2, delay: 1, repeatDelay: 4, onRepeat: function () {
...
var createAnimation = function () {
    ...
    gsap.set(bubble1, { scale: .5, x: 7, y: -37, transformOrigin: "0% 100%" })
    ...
    timeline.addLabel("frame1")
        ...
        .from(cta, { duration: .35, scale: .5, alpha: 0, ease: "power1.out" }, "frame3+=1")

        .from(logos, { duration: .35, scale: .75, alpha: 0, ease: "power1.out" }, "frame3+=1.2")
