...
var createAnimation = function () {
    ...
    gsap.set(bubble1, { scale: .5, x: 181, y: -108, transformOrigin: "33% 100%" })
    ...
    gsap.set(logos, { transformOrigin: "50% 100%" })
     ...
     gsap.set(image1Container, { x:-120})
    ...
    timeline.addLabel("frame1")
       ...
       .from(bubble1, { duration: .35, scale: 0, transformOrigin: "33% 100%", ease: "back.out(1.7)" }, "frame1")

       .to(image1Container, { duration: 3, ease: "power1.inOut" }, "frame1")
        ...
        .from([image2Container,logo], { duration: 1, x: "-=50",alpha:0, ease: "power1.inOut"}, "frame3+=0.1")
