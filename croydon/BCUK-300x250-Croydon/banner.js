...
var image1, image2, image1Container, image2Container, bubble1, bubble2, logo, logos, cover1, cover2, cover3, copy1, copy2, cta, footer
...
var createAnimation = function () {
    ...
    gsap.set(bubble1, { scale: .5, x: 117, y: -98, transformOrigin: "0% 100%" })
    gsap.set(bubble2, { scale: .5, x:157, y: 51, transformOrigin: "50% 100%" })
    ...
    timeline.addLabel("frame1")
       ...
       .from(bubble1, { duration: .35, scale: 0, transformOrigin: "0% 100%", ease: "back.out(1.7)" }, "frame1")

       //.to(image1Container, { duration: 4, x: -110, ease: "power1.inOut" }, "frame1")

        //.to(bubble1, { duration: .3, alpha: 0, ease: "none" }, "frame1+=2.5")

        .from(bubble2, { duration: .35, scale: 0, transformOrigin: "50% 100%", ease: "back.out(1.7)" }, "frame1+=1.5")
